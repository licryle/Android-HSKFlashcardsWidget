Pod::Spec.new do |spec|
    ...
    spec.authors                  = ''
    spec.license                  = ''
    spec.summary                  = 'HSK Flashcards cross-platform module'
    ...
    if !Dir.exist?('build/cocoapods/framework/crossPlatform.framework') || Dir.empty?('build/cocoapods/framework/crossPlatform.framework')
        ...
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:
            ./gradlew :crossPlatform:generateDummyFramework
    ...
    spec.pod_target_xcconfig = {
        'KOTLIN_PROJECT_PATH' => ':crossPlatform',
        'PRODUCT_MODULE_NAME' => 'crossPlatform',
    }
    spec.script_phases = [
        {
