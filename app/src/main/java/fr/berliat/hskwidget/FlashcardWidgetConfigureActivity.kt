 ...
 */
class FlashcardWidgetConfigureActivity : Activity() {
    ...
    public override fun onCreate(icicle: Bundle?) {
        ...
        appWidgetText.setText(loadTitlePref(this@FlashcardWidgetConfigureActivity, appWidgetId))
    }

}

private const val PREFS_NAME = "fr.berliat.hskwidget.FlashcardWidget"
